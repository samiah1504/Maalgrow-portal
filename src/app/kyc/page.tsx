...
export default async function KycPage() {
  ...
  const { data: investor } = await db
    .from("investors")
    .select(
      "id, full_name, investor_code, email, phone, address, bvn, nin, bank_name, account_name, account_number, kyc_status, kyc_notes, kyc_submitted_at"
    )
  ...
  // Already submitted and not rejected → straight to the portal.
  if (investor.kyc_submitted_at && investor.kyc_status !== "rejected") {
    redirect("/dashboard");
  }
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted mt-0.5">
                  Investor {investor.investor_code} · This is required before you can
                  access your MaalGrow portal.
                </p>
              </div>
            </div>
